...
int main(int argc, const char * argv[]) {
    ...
    while (1) {
...
#else
        {
            ...
            int my_barrier_time_ms, my_current_time_ms;
            clock_gettime(1, &my_tp);
            my_current_time_ms = my_tp.tv_sec*1000 + my_tp.tv_nsec/1000000;
            my_barrier_time_ms = my_current_time_ms + 100;

            while (my_current_time_ms < my_barrier_time_ms) {
                clock_gettime(1, &my_tp);
                my_current_time_ms = my_tp.tv_sec*1000 + my_tp.tv_nsec/1000000;
                pthread_yield();
            }
